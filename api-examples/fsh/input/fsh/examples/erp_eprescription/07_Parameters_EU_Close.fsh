...
* identifier[+].system = "http://local-identifier.esp/practitioner-id"
...
* identifier[+].system = "http://local-identifier.esp/pharmacia-id"
* identifier[=].value = "1234567890"
* identifier[+].system = "http://eu-unified-identifier.eu/pharmacy"
