Instance: erp-abrufen-06-request-taskDispense
InstanceOf: GEM_ERP_PR_PAR_DispenseOperation_Input
Usage: #example
* parameter[rxDispensation]
  * part[medicationDispense]
    * resource = erp-abrufen-06-request-taskDispense-medicationDispense
  * part[medication]
    * resource = SumatripanMedication


Instance: erp-abrufen-06-request-taskDispense-medicationDispense
