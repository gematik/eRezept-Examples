...
INPUT_DIR="$SCRIPT_DIR/fsh/fsh-generated/resources"
OUTPUT_DIR="$SCRIPT_DIR/output"
TEMPLATE_DIR="$SCRIPT_DIR/fsh/input/fsh/examples"
API_EXAMPLES_DIR="$SCRIPT_DIR/generated-examples"
